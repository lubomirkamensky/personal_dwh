CREATE OR REPLACE VIEW pdwh_mart_weather.va_all_measures_daily4year AS
SELECT
  Day_id,
  Actual_Rain,
  ...
  Records_count
FROM
    pdwh_mart_weather.v_all_measures_daily4year
UNION ALL
SELECT
  adj.Day_id,
  adj.Actual_Rain,
  ...
  adj.Records_count
FROM
    pdwh_mart_weather.t_adj_all_measures_daily adj
INNER JOIN
    pdwh_mart_weather.t_loaded_periods tm
    ON adj.Day_Id >= LEFT(tm.Day_Id,4)*10000
;