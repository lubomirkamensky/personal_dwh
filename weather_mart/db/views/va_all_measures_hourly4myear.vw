CREATE OR REPLACE VIEW pdwh_mart_weather.va_all_measures_hourly4year AS
SELECT
  Hour_id,
  Actual_Rain,
  ...
  Records_count
FROM
    pdwh_mart_weather.v_all_measures_hourly4year
UNION ALL
SELECT
  adj.Hour_id,
  adj.Actual_Rain,
...
INNER JOIN
    ...
    ON adj.Hour_id >= LEFT(tm.Day_Id,4)*1000000;