CREATE OR REPLACE VIEW pdwh_mart_weather.va_all_measures_monthly4month AS
SELECT
  Month_id,
  Actual_Rain,
  ...
  Records_count
FROM
    pdwh_mart_weather.v_all_measures_monthly4month
UNION ALL
SELECT
  adj.Month_id,
  adj.Actual_Rain,
...
INNER JOIN
    ...
    ON adj.Month_id >= LEFT(tm.Day_Id,6)